"""
Experiment B: Negative initialization with negative currents
Tests if gradient errors persist in the negative half-plane.
"""
...
print("=" * 80)
print("EXPERIMENT B: NEGATIVE INITIALIZATION WITH NEGATIVE CURRENTS")
print("=" * 80)
...
dyn.initialize_from_kinematics([0, 0, -0.01], 94.3)  # NEGATIVE initialization
seed = dyn.get_seed_state()

currents = np.array([0.1, 0.05, -0.02])  # NEGATIVE c3

print("Initialization currents: [0, 0, -0.01]")
print("Test currents:", currents)
print("Insertion depth:", 94.3)

# ============================================================================
# Run same tests as Experiment A
# ============================================================================
