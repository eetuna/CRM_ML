...
- **[greybox_modeling.m](./matlab/greybox_modeling.m)** - Grey-box identification
  - Uses physics structure with unknown parameters
...
├── catheterdata/                 # Physical parameter configs
├── parameters/                   # Identified parameters (.mat files)
├── 3D_dynamic_response_data_0124/  # Experimental trajectory data (6.7MB)
│   ├── input_currents/           # Actuation signals
│   ├── desired_input_trajectories/  # Target paths
│   └── output_trajectories/      # Measured responses (1-100 Hz)
├── hybrid_data/                  # Hybrid model data
...
- `CatheterParameterSet_*.txt` - Physical parameters
- `CatheterSpatialConfiguration_*.txt` - Environment setup

### Parameter Files
- **catheterdata/**: Text files with physical properties
  - Young's modulus, cross-sectional radii
  - Coil mass, magnetic dipole moments
  - Segment lengths and types

- **parameters/**: MATLAB .mat files with identified parameters
...
- Trajectories: `3D_dynamic_response_data_0124/output_trajectories/`
- Currents: `3D_dynamic_response_data_0124/input_currents/`
...
- Parameter files organized in `/parameters/` directory
