...
- Artifacts: `data/output/sweep_failures_py.json`, `data/output/sweep_failures_cpp.json`
...
- Params/units: verify radii/mass/damping units and dataset-specific current flips (`flip_third_current`) are consistent.
