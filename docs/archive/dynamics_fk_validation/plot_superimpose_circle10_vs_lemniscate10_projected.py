"""
Superimpose projected circle (r=10) and projected lemniscate (a=10) trajectories.
...
Outputs:
  - plots/superimpose_projected_circle10_vs_lemniscate10_xy.png
  - plots/superimpose_projected_circle10_vs_lemniscate10_multiview.png
"""
...
def main() -> None:
    ...
    ax.legend(loc="best")
    fig.tight_layout()
    fig.savefig(plots / "superimpose_projected_circle10_vs_lemniscate10_xy.png", dpi=200)
    plt.close(fig)
    ...
    fig.tight_layout()
    fig.savefig(plots / "superimpose_projected_circle10_vs_lemniscate10_multiview.png", dpi=200)
    plt.close(fig)

    print("Saved: plots/superimpose_projected_circle10_vs_lemniscate10_xy.png")
    print("Saved: plots/superimpose_projected_circle10_vs_lemniscate10_multiview.png")
