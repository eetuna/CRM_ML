...
- `output_data/workspace_fk_ins94.3_b0.3_step0.01_int0.2.npz`
...
- Script: `scripts/fk_ik_test_projected_workspace_dp.py`
- Parameters (tightened to hit 0.1mm):
  - `step_size = 1e-3`
...
- `output_data/circle1_currents_y40_r10_dp_0p1mm_n200.csv`
- `output_data/circle2_currents_y-40_r10_dp_0p1mm_n200.csv`
- Combined: `output_data/circle_currents_ypm40_r10_dp_0p1mm_n200.csv`
...
- Data: `output_data/dyn_fk_ramped_circles_hold2_rerun.npz`
- Figures:
...
- Data: `output_data/dyn_fk_ramped_circles_hold1.npz`
- Figures:
...
- Data: `output_data/dyn_fk_ramp_circle1_hold1.npz`
- Figures:
...
- Data: `output_data/dyn_fk_ramp_circle1_hold2.npz`
- Figures:
...
- Desired circles:
  - `output_data/circle1_desired_y40_r10.csv`
  - `output_data/circle2_desired_y-40_r10.csv`
  - `output_data/circle_desired_ypm40_r10.csv`
- Projected circles (onto workspace):
  - `output_data/circle1_projected_ws_y40_r10.csv`
  - `output_data/circle2_projected_ws_y-40_r10.csv`
  - `output_data/circle_projected_ws_ypm40_r10.csv`
- Combined (desired + projected + ramps, hold=2):
  - `output_data/circle_des_proj_and_ramps_hold2_labeled.csv`
  - `output_data/circle_proj_and_ramps_hold2_labeled.csv`
- Combined (projected + ramps, hold=1):
  - `output_data/circle_proj_and_ramps_hold1_labeled.csv`

## Replaying the current files

Replay doc:

- `output_data/RUN_INSTRUCTIONS_currents_y40_r10.md`
...
- Workspace cache with `DU0`:
  - `output_data/workspace_fk_ins94.3_b0.3_step0.01_int0.2_withDU0.npz`
