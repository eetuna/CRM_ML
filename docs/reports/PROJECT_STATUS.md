...
**Artifacts**:
- `data/output/sweep_failures_py.json`, `data/output/sweep_failures_cpp.json` - identical failing cases at dt=0.05
...
4. **Experimental Validation**
   - Run full validation against `data/experimental/`
